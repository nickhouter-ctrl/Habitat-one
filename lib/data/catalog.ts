...
export const collections: { id: Collection; key: string }[] = [
  ...
  { id: "pvc-vloeren", key: "collectionPVCFloors" },
...
export function featuredProducts(n = 8): CatalogProduct[] {
  ...
  const byCol: Record<string, CatalogProduct[]> = { "wall-panels": [], "backer-boards": [], bathroom: [], accessories: [], doors: [], "door-accessories": [], bloempotten: [], verlichting: [], schakelmateriaal: [], acrylpanelen: [], sfeerhaarden: [], "pvc-vloeren": [] };
  ...
  let i = 0;
  while (picked.length < n && (byCol["wall-panels"].length || byCol["backer-boards"].length || byCol.bathroom.length || byCol.accessories.length || byCol.doors.length || byCol["door-accessories"].length || byCol.bloempotten.length || byCol.verlichting.length || byCol.schakelmateriaal.length || byCol.acrylpanelen.length || byCol.sfeerhaarden.length || byCol["pvc-vloeren"].length)) {
    const order = i % 2 === 0 ? ["wall-panels", "pvc-vloeren", "bloempotten", "verlichting", "schakelmateriaal", "acrylpanelen", "sfeerhaarden", "backer-boards", "bathroom", "doors", "door-accessories", "accessories"] : ["bathroom", "wall-panels", "pvc-vloeren", "doors", "verlichting", "schakelmateriaal", "acrylpanelen", "sfeerhaarden", "bloempotten", "backer-boards", "door-accessories", "accessories"];
