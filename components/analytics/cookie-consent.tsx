...
const TXT: Record<string, { body: string; accept: string; decline: string }> = {
  nl: { body: "We gebruiken analyse-cookies om de website te verbeteren.", accept: "Accepteren", decline: "Weigeren" },
  en: { body: "We use analytics cookies to improve this website.", accept: "Accept", decline: "Decline" },
  de: { body: "Wir verwenden Analyse-Cookies, um diese Website zu verbessern.", accept: "Akzeptieren", decline: "Ablehnen" },
  es: { body: "Usamos cookies de análisis para mejorar este sitio web.", accept: "Aceptar", decline: "Rechazar" },
};
      ...
      {!decided && (
        <div className="fixed inset-x-0 bottom-0 z-[60] p-4 md:p-5">
          <div className="surface mx-auto flex max-w-3xl flex-col items-start gap-3 rounded-2xl border border-ink/10 bg-paper p-4 shadow-lg sm:flex-row sm:items-center sm:gap-5 md:p-5">
            <p className="flex-1 text-sm leading-relaxed text-ink-soft">{t.body}</p>
